export const cart = {
  ...
  delivery: {
    type: {
      true: {shortText: 'Пункт выдачи', text: 'Доставка в пункт выдачи'},
    ...
    address: new Map([
      [0, 'Бишкек, улица Табышалиева, 57'],
      [1, 'Бишкек, улица Жукеева-Пудовкина, 77/1'],
      [2, 'Бишкек, микрорайон Джал, улица Ахунбаева Исы, 67/1']
    ]),
    price: 'Бесплатно',
  },
  cardInfo: [
