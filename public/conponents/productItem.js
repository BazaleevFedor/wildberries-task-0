...
class ProductItem {
  ...
  setCount(id, count, leftInStock) {
    ...
    incElem.disabled = (leftInStock && count >= leftInStock) || count === 9999;
            ...
            <div class="item-info p-t-12">
              ...
              <div class="item-info__specifications h-max-content">
                <div class="item-info__price small_components">
                  <h3 class="ff-Bold fw-700 lh-24 f-normal f-16 m-0" id="js-product-price-small-${product.id}"></h3> <!--ToDo: проброс из js-->
                ...
                <span class="specifications__name lh-24 overflow-ellipsis">${product.name}</span> <!--ToDo: проброс из js-->
                ${props}
            ...
            <div class="item-counter p-t-9">
              <div class="counter">
                <div class="product-counter br-8 bg-white">
                  ...
                  <input class="br-none outline-none w-100 ta-center f-normal fw-400 lh-24 p-0 js-product-counter" id="js-product-counter-${product.id}" data-id="${product.id}"> <!--ToDo: проброс из js-->
              ...
              <div class="item-counter__price large_components">
                <div class="price__item h-28">
                  <h3 class="ff-Bold fw-700 lh-24 f-normal f-20 m-0" id="js-product-price-${product.id}"></h3> <!--ToDo: проброс из js-->
                  <h4 class="price__currency ff-Bold fw-700 lh-24 f-normal f-16 m-0" id="js-product-currency-${product.id}"></h4> <!--ToDo: проброс из js-->
                </div>
